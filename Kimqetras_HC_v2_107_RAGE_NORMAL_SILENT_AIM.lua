-- Kimqetras HC v2.107 • v2.106 base + RAGE uses normal Silent Aim shooting
...
local KIMQ_BUILD = "v2.107-rage-normal-silent-aim"
...
Hello.Text = "v2.107  •  RAGE normal Silent Aim shooting ♡"
...
task.spawn(function()
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification",{
            Title="Kimqetras HC",
            Text="v2.107 ACTIVE ♡ • RAGE now shoots through normal Silent Aim",
            Duration=7,
        })
    end)
