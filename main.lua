...
-- v2.1 strict section ownership fix: every card belongs to exactly one feature page.
...
task.spawn(function()
    ...
    local exact = {
        ...
        ["Configs save the full setup: every registered toggle/slider/dropdown/keybind, theme, whitelist, avatar target + avatar options, local accessories, fog color/amount, environment preset, weapon-skin selections, and GUI size/position. Loading a preset restores the setup automatically."] = "settings",
        ["KIM feature backend • merged into Kimqetras HC"] = "info",
    }
