-- KIMQETRAS HC V26 - SINGLE CLEAN BUILD
-- Stable backend + one V26 interface pass.
...
-- Use the real uploaded V26 artwork in the only boot screen.
Avatar.Visible = false
local BootPompom = Instance.new("ImageLabel", Panel)
BootPompom.BackgroundTransparency = 1
BootPompom.Size = UDim2.fromOffset(92, 92)
BootPompom.Position = UDim2.fromOffset(36, 26)
BootPompom.Image = KIMQ_V26_ASSETS.Pompompurin
BootPompom.ScaleType = Enum.ScaleType.Fit

local BootTitleImage = Instance.new("ImageLabel", Panel)
BootTitleImage.BackgroundTransparency = 1
BootTitleImage.Size = UDim2.fromOffset(270, 72)
BootTitleImage.Position = UDim2.fromOffset(128, 24)
BootTitleImage.Image = KIMQ_V26_ASSETS.Title
BootTitleImage.ScaleType = Enum.ScaleType.Fit

local BootSubtitleImage = Instance.new("ImageLabel", Panel)
BootSubtitleImage.BackgroundTransparency = 1
BootSubtitleImage.Size = UDim2.fromOffset(180, 42)
BootSubtitleImage.Position = UDim2.fromOffset(174, 78)
BootSubtitleImage.Image = KIMQ_V26_ASSETS.Subtitle
BootSubtitleImage.ScaleType = Enum.ScaleType.Fit
...
-- V26 final GUI: uploaded decals, original V26 layout, no stitching.
task.spawn(function()
    local Players=game:GetService("Players")
    local CoreGui=game:GetService("CoreGui")
    local TweenService=game:GetService("TweenService")
