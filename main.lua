...
local LIME = Color3.fromRGB(239, 255, 211)
local LIME2 = Color3.fromRGB(220, 247, 180)
local PINK = Color3.fromRGB(255, 105, 174)
local PINK2 = Color3.fromRGB(255, 166, 207)
local INK = Color3.fromRGB(78, 75, 86)
local SOFT = Color3.fromRGB(132, 116, 126)
...
task.spawn(function()
    ...
    local function palette()
        local hot=badge and badge.BackgroundColor3 or Color3.fromRGB(255,92,164)
        local defaultHot=Color3.fromRGB(255,92,164)
        local isDefault=math.abs(hot.R-defaultHot.R)<.03 and math.abs(hot.G-defaultHot.G)<.03 and math.abs(hot.B-defaultHot.B)<.03
        local cream=isDefault and Color3.fromRGB(239,255,211) or hot:Lerp(Color3.new(1,1,1),.90)
        local cream2=isDefault and Color3.fromRGB(248,255,232) or hot:Lerp(Color3.new(1,1,1),.94)
        local light=isDefault and Color3.fromRGB(244,255,226):Lerp(hot,.08) or hot:Lerp(Color3.new(1,1,1),.82)
