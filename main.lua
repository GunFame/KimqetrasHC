-- Kimqetras HC v2.102 • v2.101 base + Force Hit one-click finish + WholeDifferentAnimal preset
...
local KIMQ_BUILD = "v2.102-force-hit-finish-whole-different-animal"
...
Hello.Text = "v2.102  •  Force Hit finish + WholeDifferentAnimal ♡"
...
task.spawn(function()
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification",{
            Title="Kimqetras HC",
            Text="v2.102 ACTIVE ♡ • Force Hit finish + WholeDifferentAnimal ready",
            Duration=7,
        })
    end)
