-- Kimqetras HC v2.84 • v2.82 non-RAGE base + RAGE V3 classic preview UI + Revolver camera exclusion
...
local KIMQ_BUILD = "v2.84-rage-ui-preview-avatar-revert"
...
Hello.Text = "v2.84  •  v2.82 avatar + classic RAGE preview ♡"
...
task.spawn(function()
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification",{
            Title="Kimqetras HC",
            Text="v2.84 ACTIVE ♡ • v2.82 avatar + RAGE preview ready",
            Duration=7,
        })
    end)
