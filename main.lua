-- KIMQETRAS HC v2.1 - PERFORMANCE SINGLE BUILD
...
task.spawn(function()
    ...
    -- Build a stable theme registry ONCE from explicit v2.1 role attributes plus
    -- a handful of known UI classes. Theme clicks never call GetDescendants again.
    local registry={}
    local function add(o,role)
        if o and not isExcluded(o) then table.insert(registry,{o=o,role=role}) end
    end
    local roleMap={cream="bg",cream2="bg2",panel="panel",lightBg="soft",hotBg="hot",whiteBg="white",hotText="hotText",subText="subText",textText="textText",lineText="lineText",whiteText="whiteText",limeText="textText"}
    for _,d in ipairs(main:GetDescendants()) do
        ...
        if d:IsA("UIStroke") then add(d,"stroke") end
    ...
    local function applyTheme(name)
        ...
        for _,e in ipairs(registry) do
            ...
            if o and o.Parent then
                ...
                elseif r=="lineText" and (o:IsA("TextLabel") or o:IsA("TextButton") or o:IsA("TextBox")) then o.TextColor3=p.line
