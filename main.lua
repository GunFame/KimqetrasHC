-- Kimqetras HC v2.105 • v2.104 base + brighter world lights + deeper corner shadows + compact GUI organizer
...
local KIMQ_BUILD = "v2.105-lights-deep-shadows-clean-ui"
...
Hello.Text = "v2.105  •  lights + deep shadows + clean UI ♡"
...
task.spawn(function()
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification",{
            Title="Kimqetras HC",
            Text="v2.105 ACTIVE ♡ • lights + deep shadows + clean UI ready",
            Duration=7,
        })
    end)
...
-- ========================================================
-- v2.105 COMPACT FEATURE PAGE ORGANIZER (VISUAL ONLY)
