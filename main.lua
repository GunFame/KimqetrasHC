-- Kimqetras HC v2.101 • v2.100 base + Force Hit rebuilt through real weapon pipeline
...
local KIMQ_BUILD = "v2.101-force-hit-real-weapon-pipeline"
...
Hello.Text = "v2.101  •  rebuilt Force Hit + clean combat ♡"
...
function ForceHit.MouseClick(action, state, input)
    ...
    if part then
        ...
        -- Return Pass so the actual weapon script still performs the shot.
        ForceHit.Prime(part, 0.30)
...
task.spawn(function()
    ...
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification",{
            Title="Kimqetras HC",
            Text="v2.101 ACTIVE ♡ • Force Hit rebuilt through your weapon",
            Duration=7,
        })
    end)
