-- V26 LITE: same V26 look/features, legacy loader/patch stack removed for performance.
...
task.spawn(function()
    ...
    task.wait(3.0) -- optimized: enough time for the retained V15 patch to settle
...
task.spawn(function()
    ...
    local function forceBadge()
        for _,d in ipairs(main:GetDescendants()) do if d:IsA("TextLabel") and tostring(d.Text or ""):match("^V%d+") then d.Text="V26L ♥" end end
    end
    forceBadge()
