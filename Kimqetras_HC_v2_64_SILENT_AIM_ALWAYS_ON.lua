-- Kimqetras HC v2.64 • v2.63 base + Silent Aim always-on
...
local KIMQ_BUILD = "v2.64-silentaim-always-on"
...
do
    ...
    if running and runningBuild == KIMQ_BUILD then
        ...
        pcall(function()
            StarterGui0:SetCore("SendNotification",{
                Title="Kimqetras HC",
                Text=(runtimeState=="ready") and "v2.64 is already running ♡" or "v2.64 is already starting ♡",
                Duration=4,
            })
        end)
        return
    ...
    if oldRuntimeDetected then
        ...
        warn("[Kimqetras HC v2.64] Older runtime detected. Refusing to stack; rejoin once.")
        return
    end
...
Hello.Text = "v2.64  •  silent aim always on ♡"
