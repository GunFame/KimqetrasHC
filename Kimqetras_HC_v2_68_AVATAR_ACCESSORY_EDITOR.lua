-- Kimqetras HC v2.68 • v2.67 base + isolated copied-avatar accessory visibility editor
...
local KIMQ_BUILD = "v2.68-avatar-accessory-editor"
...
Hello.Text = "v2.68  •  avatar accessory editor ♡"
    ...
    if ok then
        ...
        task.defer(function()
            ...
            if char and char.Parent then
                ...
                -- Apply once more after layered/classic accessories finish settling.
